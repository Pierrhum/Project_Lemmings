...
public:
    DrawLemming() :
        ...
        Quit(new Animation("spriteAscii/button/quitButton.txt", 1), COORD{170, 55}, UIButton::QUIT),
        Play(new Animation("spriteAscii/button/playButton.txt", 1), COORD{140, 55}, UIButton::PLAY),
